...
このため、pdf データ（[例えばこちら](https://web.archive.org/web/20210829113548/https://www.fukushihoken.metro.tokyo.lg.jp/iryo/kansen/corona_portal/info/kunishihyou.files/kuni0828.pdf)）の下から 3 行、「病床全体の使用率」「入院率」「重症者用病床の使用率」に関連する項目の一部では、表頭として「……_分子」「……_分母」という機械的な名称を採用しています。
